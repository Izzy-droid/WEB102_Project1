  ...
  return (
    ...
    <h2>An array of plants in your garden that your cat can safely eat</h2>
     ...
     <div className="card-arrange">
       <div className="card">
        <img src="basil.png" className="plant-img" alt="photo of a basil plant"></img>
         <h2>{plant1}</h2>
      ...
      <div className="card">
      <img src="Rosemary.png" className="plant-img" alt="photo of a rosemary plant"></img>
         <h2>{plant2}</h2>
      ...
      <div className="card">
      <img src="Bamboo.png" className="plant-img" alt="photo of a bamboo plant"></img>
         <h2>*{plant3}</h2>
      ...
      <div className="card">
      <img src="Valerian.png" className="plant-img" alt="photo of a valerian plant"></img>
         <h2>{plant4}</h2>
      ...
      <div className="card">
      <img src="Parsley.png" className="plant-img" alt="photo of a valerian plant"></img>
         <h2>{plant5}</h2>
      ...
      <div className="card">
      <img src="Silver Vine.png" className="plant-img" alt="photo of a Silver Vine plant"></img>
         <h2>{plant6}</h2>
      ...
      <div className="card">
      <img src="Catnip.png" className="plant-img" alt="photo of a Catnip plant"></img>
         <h2>{plant7}</h2>
      ...
      <div className="card">
      <img src="Mint.png" className="plant-img" alt="photo of a Mint plant"></img>
         <h2>{plant8}</h2>
      ...
      <div className="card">
      <img src="Thyme.png" className="plant-img" alt="photo of a Thyme plant"></img>
         <h2>{plant9}</h2>
      ...
      <div className="card">
      <img src="Lemongrass.png" className="plant-img" alt="photo of a Lemongrass plant"></img>
         <h2>{plant10}</h2>
